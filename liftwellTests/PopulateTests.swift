...
class PopulateTests: XCTestCase {
    func testRepsSublabel() {
        ...
        XCTAssertEqual(sets.sublabel(apparatus, 100.0, 10, limit: 100, worksetBias: 0), "2x10 @ 100 lbs")
        ...
        XCTAssertEqual(sets.sublabel(apparatus, 100.0, 4, limit: 100, worksetBias: 0), "2x4-8 @ 100 lbs")
    }
}
