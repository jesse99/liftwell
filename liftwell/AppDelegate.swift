...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    private func loadResults() {
        ...
        if let data = NSKeyedUnarchiver.unarchiveObject(withFile: path) as? Data {
            do {
                ...
                PercentSubType.results = getStrDict(store, "percent-results")
    ...
    func saveResults() {
        ...
        addStrDict(store, "percent-results", PercentSubType.results)
    ...
    let programs = [BestButt14(), BestButt58(), BestButt912(), Bootyful3a(), Bootyful3b(), Bootyful3c(), Bootyful14a(), Bootyful14b(), Bootyful14c(), FiveThreeOneBeginner(), GlutealGoddess1(), GlutealGoddess2(), GlutealGoddess3(), GorgeousGlutes1(), GorgeousGlutes2(), GorgeousGlutes3(), GZCLP3(), GZCLP4(), MastersDB(), PhraksGreyskull()]
