...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    let programs = [BestButt14(), BestButt58(), BestButt912(), Bootyful3a(), Bootyful3b(), Bootyful3c(), Bootyful14a(), Bootyful14b(), Bootyful14c(), FiveThreeOneBeginner(), GZCLP3(), GZCLP4(), Mine2(), PhraksGreyskull()]
