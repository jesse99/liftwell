...
fileprivate let booty14Exercises: [Exercise] = [
    // A
    bodyweight("Glute Bridge",              "Glute Bridge",               "10-20 R 10-20 R 10-20", restMins: 0.5, main: true),
    dumbbell1("One Arm Row",                "Kroc Row",                   "", "8-12 R 8-12 R 8-12", restMins: 0.5, main: true),
    bodyweight("Box Squat",                 "Body-weight Box Squat",      "10-20 R 10-20 R 10-20", restMins: 1.0, main: true),
    dumbbell2("Dumbbell Bench Press",       "Dumbbell Bench Press",       "", "8-12 R 8-12 R 8-12", restMins: 1.0, main: true),
    dumbbell2("Dumbbell Romanian Deadlift", "Dumbbell Romanian Deadlift", "", "10-20 R 10-20 R 10-20", restMins: 1.0, main: true),
    bodyweight("Side Lying Abduction",      "Side Lying Abduction",       "15-30 R 15-30", restMins: 0.5),
    bodyweight("Front Plank",               "Front Plank",                1, secs: 20, targetSecs: 120),
    bodyweight("Side Plank from Knees",     "Side Plank",                 2, secs: 20, targetSecs: 60),
    
    // B
    // Glute Bridge
    cable("Lat Pulldown",       "Lat Pulldown",            "", "8-12 R 8-12 R 8-12", restMins: 1.0, main: true),
    bodyweight("Step-up",         "Step-ups",                "10-20 R 10-20 R 10-20", restMins: 0.5, main: true),
    dumbbell2("Dumbbell OHP",      "Dumbbell Shoulder Press", "", "8-12 R 8-12 R 8-12", restMins: 1.0, main: true),
    bodyweight("Back Extension",  "Back Extension",          "10-20 R 10-20 R 10-20", restMins: 0.5),
    ...
    cable("Seated Row",                 "Seated Cable Row",                "", "8-12 R 8-12 R 8-12", restMins: 1.0, main: true),
    bodyweight("Body-weight Squat",     "Body-weight Squat",               "10-20 R 10-20 R 10-20", restMins: 1.0, main: true),
    dumbbell2("Dumbbell Incline Press", "Dumbbell Incline Press",          "", "8-12 R 8-12 R 8-12", restMins: 1.0, main: true),
    bodyweight("Romanian Deadlift",     "Body-weight Single Leg Deadlift", "10-20 R 10-20 R 10-20", restMins: 0.5, main: true),
...
fileprivate let booty58Exercises: [Exercise] = [
    // A
    bodyweight("Hip Thrust",              "Body-weight Hip Thrust",               "10-20 R 10-20 R 10-20", restMins: 0.5, main: true),
    cable("One Arm Cable Row",          "Standing One Arm Cable Row",           "", "8-12 R 8-12 R 8-12", restMins: 0.5, main: true),
    bodyweight("Step Up + Reverse Lunge", "Body-weight Step Up + Reverse Lunge",  "10-20 R 10-20 R 10-20", restMins: 0.5, main: true),
    barbell("Bench Press",                "Bench Press",                          "", "8-12 R 8-12 R 8-12", restMins: 2.0, main: true),
    barbell("Romanian Deadlift",          "Romanian Deadlift",                    "", "10-20 R 10-20 R 10-20", restMins: 2.0, main: true),
    ...
    // B
    bodyweight("Glute Bridge",           "Glute Bridge",              "10-20 R 10-20 R 10-20", restMins: 0.5, main: true),
    bodyweight("Negative Chinup",        "Chinup",                    "3 R 3 R 3", restMins: 1.0, main: true),
    bodyweight("Walking Lunge",          "Body-weight Walking Lunge", "10-20 R 10-20 R 10-20", restMins: 1.0, main: true),
    dumbbell2("Dumbbell OHP",            "Dumbbell Shoulder Press",   "", "8-12 R 8-12 R 8-12", restMins: 1.0, main: true),
    bodyweight("Reverse Hyperextension", "Reverse Hyperextension",    "10-20 R 10-20 R 10-20", restMins: 0.5),
    ...
    // C
    bodyweight("Hip Thrust (paused)", "Hip Thrust (rest pause)",  "10-20 R 10-20 R 10-20", restMins: 0.5, main: true),
    bodyweight("Inverted Row",        "Inverted Row",             "8-12 R 8-12 R 8-12", restMins: 0.5, main: true),
    dumbbell1("Goblet Squat",         "Goblet Squat",             "", "10-20 R 10-20 R 10-20", restMins: 2.0, main: true),
    barbell("Close-Grip Bench Press", "Close-Grip Bench Press",   "", "8-12 R 8-12 R 8-12", restMins: 2.0, main: true),
    bodyweight("Kettlebell Swing",    "Kettlebell Two Arm Swing", "10-20 R 10-20 R 10-20", restMins: 0.5),
...
fileprivate let booty912Exercises: [Exercise] = [
    // A
    barbell("Hip Thrust",              "Hip Thrust",             "", "10-20 R 10-20 R 10-20", restMins: 1.0, main: true),
    dumbbell2("Dumbbell Row",           "Bent Over Dumbbell Row", "", "8-12 R 8-12 R 8-12", restMins: 1.0, main: true),
    barbell("Box Squat",               "Box Squat",              "", "10-20 R 10-20 R 10-20", restMins: 2.0, main: true),
    bodyweight("Pushup",               "Pushup",                 "3-10 R 3-10 R 3-10", restMins: 0.5, main: true),
    barbell("Deadlift",                "Deadlift",               "", "10-20 R 10-20 R 10-20", restMins: 2.0, main: true),
    bodyweight("Side Lying Abduction", "Side Lying Abduction",   "15-30", restMins: 0.5),
    ...
    // B
    bodyweight("Single Leg Hip Thrust", "Body-weight Single Leg Hip Thrust", "10-20 R 10-20 R 10-20", restMins: 1.0, main: true),
    bodyweight("Chinup",                "Chinup",                            "1-5 R 1-5 R 1-5", restMins: 1.0, main: true),
    bodyweight("Bulgarian Split Squat", "Body-weight Bulgarian Split Squat", "10-20 R 10-20 R 10-20", restMins: 1.0, main: true),
    dumbbell1("One Arm OHP",             "Dumbbell One Arm Shoulder Press",   "", "8-12 R 8-12 R 8-12", restMins: 1.0, main: true),
    barbell("Good Morning",             "Good Morning",                      "", "10-20 R 10-20 R 10-20", restMins: 1.0, main: true),
    bodyweight("X-Band Walk",           "X-Band Walk",                       "15-30", restMins: 0.5),
    bodyweight("Decline Plank",         "Decline Plank",                     1, secs: 60, targetSecs: 120),
    dumbbell2("Side Bend",              "Dumbbell Side Bend",                "", "15-30", restMins: 1.0),
    
    // C
    barbell("Hip Thrust (paused)",   "Hip Thrust (rest pause)", "", "8-12 R 8-12 R 8-12", restMins: 1.0, main: true),
    dumbbell2("Incline Row",          "Dumbbell Incline Row",    "", "8-12 R 8-12 R 8-12", restMins: 1.0, main: true),
    barbell("Squat",                 "Low bar Squat",           "", "10-20 R 10-20 R 10-20", restMins: 2.0, main: true),
    barbell("Incline Bench Press",   "Incline Bench Press",     "", "3-10 R 3-10 R 3-10", restMins: 2.0, main: true),
    bodyweight("Back Extension",     "Back Extension",          "10-30 R 10-30 R 10-30", restMins: 0.5),
    bodyweight("Clam",               "Clam",                    "15-30", restMins: 0.5),
