...
fileprivate let booty14Exercises: [Exercise] = [
    // A
    bodyweight("Glute Bridge",              "Glute Bridge",               "10-20 R 10-20 R 10-20", restMins: 0.5),
    dumbbell1("One Arm Row",                "Kroc Row",                   "", "8-12 R 8-12 R 8-12", restMins: 0.5),
    bodyweight("Box Squat",                 "Body-weight Box Squat",      "10-20 R 10-20 R 10-20", restMins: 1.0),
    dumbbell2("Dumbbell Bench Press",       "Dumbbell Bench Press",       "", "8-12 R 8-12 R 8-12", restMins: 1.0),
    dumbbell2("Dumbbell Romanian Deadlift", "Dumbbell Romanian Deadlift", "", "10-20 R 10-20 R 10-20", restMins: 1.0),
    ...
    // B
    // Glute Bridge
    cable("Lat Pulldown",       "Lat Pulldown",            "", "8-12 R 8-12 R 8-12", restMins: 1.0),
    bodyweight("Step-up",         "Step-ups",                "10-20 R 10-20 R 10-20", restMins: 0.5),
    dumbbell2("Dumbbell OHP",      "Dumbbell Shoulder Press", "", "8-12 R 8-12 R 8-12", restMins: 1.0),
    ...
    cable("Seated Row",                 "Seated Cable Row",                "", "8-12 R 8-12 R 8-12", restMins: 1.0),
    bodyweight("Body-weight Squat",     "Body-weight Squat",               "10-20 R 10-20 R 10-20", restMins: 1.0),
    dumbbell2("Dumbbell Incline Press", "Dumbbell Incline Press",          "", "8-12 R 8-12 R 8-12", restMins: 1.0),
    bodyweight("Romanian Deadlift",     "Body-weight Single Leg Deadlift", "10-20 R 10-20 R 10-20", restMins: 0.5),
...
fileprivate let booty58Exercises: [Exercise] = [
    // A
    bodyweight("Hip Thrust",              "Body-weight Hip Thrust",               "10-20 R 10-20 R 10-20", restMins: 0.5),
    cable("One Arm Cable Row",          "Standing One Arm Cable Row",           "", "8-12 R 8-12 R 8-12", restMins: 0.5),
    bodyweight("Step Up + Reverse Lunge", "Body-weight Step Up + Reverse Lunge",  "10-20 R 10-20 R 10-20", restMins: 0.5),
    barbell("Bench Press",                "Bench Press",                          "", "8-12 R 8-12 R 8-12", restMins: 2.0),
    barbell("Romanian Deadlift",          "Romanian Deadlift",                    "", "10-20 R 10-20 R 10-20", restMins: 2.0),
    ...
    // B
    bodyweight("Glute Bridge",           "Glute Bridge",              "10-20 R 10-20 R 10-20", restMins: 0.5),
    bodyweight("Negative Chinup",        "Chinup",                    "3 R 3 R 3", restMins: 1.0),
    ...
    // C
    bodyweight("Hip Thrust (paused)", "Hip Thrust (rest pause)",  "10-20 R 10-20 R 10-20", restMins: 0.5),
    bodyweight("Inverted Row",        "Inverted Row",             "8-12 R 8-12 R 8-12", restMins: 0.5),
    dumbbell1("Goblet Squat",         "Goblet Squat",             "", "10-20 R 10-20 R 10-20", restMins: 2.0),
    barbell("Close-Grip Bench Press", "Close-Grip Bench Press",   "", "8-12 R 8-12 R 8-12", restMins: 2.0),
...
fileprivate let booty912Exercises: [Exercise] = [
    // A
    barbell("Hip Thrust",              "Hip Thrust",             "", "10-20 R 10-20 R 10-20", restMins: 1.0),
    dumbbell2("Dumbbell Row",           "Bent Over Dumbbell Row", "", "8-12 R 8-12 R 8-12", restMins: 1.0),
    barbell("Box Squat",               "Box Squat",              "", "10-20 R 10-20 R 10-20", restMins: 2.0),
    bodyweight("Pushup",               "Pushup",                 "3-10 R 3-10 R 3-10", restMins: 0.5),
    barbell("Deadlift",                "Deadlift",               "", "10-20 R 10-20 R 10-20", restMins: 2.0),
    bodyweight("Side Lying Abduction", "Side Lying Abduction",   "15-30", restMins: 0.5),
    ...
    // B
    bodyweight("Single Leg Hip Thrust", "Body-weight Single Leg Hip Thrust", "10-20 R 10-20 R 10-20", restMins: 1.0),
    bodyweight("Chinup",                "Chinup",                            "1-5 R 1-5 R 1-5", restMins: 1.0),
    bodyweight("Bulgarian Split Squat", "Body-weight Bulgarian Split Squat", "10-20 R 10-20 R 10-20", restMins: 1.0),
    dumbbell1("One Arm OHP",             "Dumbbell One Arm Shoulder Press",   "", "8-12 R 8-12 R 8-12", restMins: 1.0),
    barbell("Good Morning",             "Good Morning",                      "", "10-20 R 10-20 R 10-20", restMins: 1.0),
    bodyweight("X-Band Walk",           "X-Band Walk",                       "15-30", restMins: 0.5),
    bodyweight("Decline Plank",         "Decline Plank",                     1, secs: 60, targetSecs: 120),
    dumbbell2("Side Bend",              "Dumbbell Side Bend",                "", "15-30", restMins: 1.0),
    
    // C
    barbell("Hip Thrust (paused)",   "Hip Thrust (rest pause)", "", "8-12 R 8-12 R 8-12", restMins: 1.0),
    dumbbell2("Incline Row",          "Dumbbell Incline Row",    "", "8-12 R 8-12 R 8-12", restMins: 1.0),
    barbell("Squat",                 "Low bar Squat",           "", "10-20 R 10-20 R 10-20", restMins: 2.0),
    barbell("Incline Bench Press",   "Incline Bench Press",     "", "3-10 R 3-10 R 3-10", restMins: 2.0),
