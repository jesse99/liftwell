...
func BestButt14() -> Program {
    let exercises: [Exercise] = [
        // A
        bodyweight("Glute Bridge",          "Glute Bridge",          "10-20 R 10-20 R 10-20", restMins: 1.0, main: true),
        bodyweight("Inverted Row",          "Inverted Row",          "8-12 R 8-12 R 8-12", restMins: 1.0, main: true),
        bodyweight("Box Squat",             "Body-weight Box Squat", "10-20 R 10-20 R 10-20", restMins: 1.5, main: true),
        bodyweight("Incline Pushup",        "Incline Pushup",        "8-12 R 8-12 R 8-12", restMins: 1.0, main: true),
        ...
        // B
        bodyweight("Elevated Single-leg Glute Bridge", "Single Leg Glute Bridge",      "10-20 R 10-20 R 10-20", restMins: 1.0, main: true),
        bodyweight("Negative Chinup",                  "Chinup",                       "1-3 R 1-3 R 1-3", restMins: 1.5, main: true),
        bodyweight("Step-ups",                         "Deep Step-ups",                "10-20 R 10-20 R 10-20", restMins: 1.0, main: true),
        bodyweight("Pushup from Knees",                "Pushup",                       "5-15 R 5-15 R 5-15", restMins: 1.0, main: true),
        ...
        bodyweight("Inverted Row",           "Inverted Row",              "8-12 R 8-12 R 8-12", restMins: 1.0, main: true),
        bodyweight("Box Squat",              "Body-weight Box Squat",     "10-20 R 10-20 R 10-20", restMins: 1.5, main: true),
        bodyweight("Negative Pushup",        "Pushup",                    "3-5 R 3-5 R 3-5", restMins: 1.0, main: true),
        bodyweight("Hip Hinge with Dowel",   "Hip Hinge with Dowel",      "10-20 R 10-20 R 10-20", restMins: 1.0),
...
func BestButt58() -> Program {
    let exercises: [Exercise] = [
        // A
        bodyweight("Hip Thrust",           "Body-weight Hip Thrust",          "10-30 R 10-30 R 10-30", restMins: 1.0, main: true),
        bodyweight("Inverted Row",         "Inverted Row",                    "8-12 R 8-12 R 8-12", restMins: 1.0, main: true),
        bodyweight("Squat",                "Body-weight Squat",               "10-30 R 10-30 R 10-30", restMins: 1.5, main: true),
        bodyweight("Pushup",               "Pushup",                          "1 R 1 R 1", restMins: 1.0, main: true),
        bodyweight("Single Leg Deadlift",  "Body-weight Single Leg Deadlift", "10-20 R 10-20 R 10-20", restMins: 1.0, main: true),
        bodyweight("Side Lying Abduction", "Side Lying Abduction",            "10-30", restMins: 1.0),
        bodyweight("RKC Plank",            "RKC Plank",                       1, secs: 20, targetSecs: 60),
        bodyweight("Side Plank",           "Side Plank",                      2, secs: 20, targetSecs: 60),
        
        // B
        bodyweight("Single-leg Glute Bridge", "Single Leg Glute Bridge",   "10-20 R 10-20 R 10-20", restMins: 1.0, main: true),
        bodyweight("Chinup",                  "Chinup",                    "1 R 1 R 1", restMins: 1.5, main: true),
        bodyweight("Walking Lunge",           "Body-weight Walking Lunge", "10-20 R 10-20 R 10-20", restMins: 1.0, main: true),
        bodyweight("Pushup from Knees",       "Pushup",                    "6-20 R 6-20 R 6-20", restMins: 1.5, main: true),
        ...
        bodyweight("Hip Thrust",             "Body-weight Hip Thrust",    "10-30 R 10-30 R 10-30", restMins: 1.0, main: true),
        bodyweight("Inverted Row",           "Inverted Row",              "8-12 R 8-12 R 8-12", restMins: 1.0, main: true),
        bodyweight("High Step-ups",          "Deep Step-ups",             "10-20 R 10-20 R 10-20", restMins: 1.0, main: true),
        bodyweight("Incline Pushup",         "Incline Pushup",            "8-12 R 8-12 R 8-12", restMins: 1.5, main: true),
...
func BestButt912() -> Program {
    let exercises: [Exercise] = [
        // A
        bodyweight("Elevated Single-leg Hip Thrust", "Body-weight Single Leg Hip Thrust",   "8-20 R 8-20 R 8-20", restMins: 1.0, main: true),
        bodyweight("Chinup",                         "Chinup",                              "3-10 R 3-10 R 3-10", restMins: 1.5, main: true),
        bodyweight("Step Up + Reverse Lunge",        "Body-weight Step Up + Reverse Lunge", "3-15 R 3-15 R 3-15", restMins: 1.5, main: true),
        bodyweight("Pushup",                         "Pushup",                              "5-10 R 5-10 R 5-10", restMins: 1.5, main: true),
        ...
        // B
        bodyweight("Elevated Hip Thrust",       "Body-weight Hip Thrust",            "6-20 R 6-20 R 6-20", restMins: 1.0, main: true),
        bodyweight("Elevated Inverted Row",     "Inverted Row",                      "6-12 R 6-12 R 6-12", restMins: 1.0, main: true),
        bodyweight("Bulgarian Split Squat",     "Body-weight Bulgarian Split Squat", "5-30 R 5-30 R 5-30", restMins: 1.0, main: true),
        bodyweight("Elevated Pike Pushup",      "Pike Pushup",                       "6-20 R 6-20 R 6-20", restMins: 1.0, main: true),
        ...
        // C
        bodyweight("Elevated Single-leg Hip Thrust",     "Body-weight Hip Thrust", "5-15 R 5-15 R 5-15", restMins: 1.5, main: true),
        bodyweight("Pullup",                             "Pullup",                 "3-10 R 3-10 R 3-10", restMins: 1.5, main: true),
        bodyweight("High Step-ups",                      "Deep Step-ups",          "3-15 R 3-15 R 3-15", restMins: 1.0, main: true),
        bodyweight("Narrow-base Pushup",                 "Pushup",                 "3-8 R 3-8 R 3-8", restMins: 1.5, main: true),
