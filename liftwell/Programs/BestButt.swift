...
func BestButt14() -> Program {
    let exercises: [Exercise] = [
        // A
        bodyweight("Glute Bridge",          "Glute Bridge",          "10-20".x(3), restMins: 1.0, main: true),
        bodyweight("Inverted Row",          "Inverted Row",          "8-12".x(3), restMins: 1.0, main: true),
        bodyweight("Box Squat",             "Body-weight Box Squat", "10-20".x(3), restMins: 1.5, main: true),
        bodyweight("Incline Pushup",        "Incline Pushup",        "8-12".x(3), restMins: 1.0, main: true),
        bodyweight("Hip Hinge with Dowel",  "Hip Hinge with Dowel",  "10-20".x(3), restMins: 1.0),
        ...
        // B
        bodyweight("Elevated Single-leg Glute Bridge", "Single Leg Glute Bridge",      "10-20".x(3), restMins: 1.0, main: true),
        bodyweight("Negative Chinup",                  "Chinup",                       "1-3".x(3), restMins: 1.5, main: true),
        bodyweight("Step-ups",                         "Deep Step-ups",                "10-20".x(3), restMins: 1.0, main: true),
        bodyweight("Pushup from Knees",                "Pushup",                       "5-15".x(3), restMins: 1.0, main: true),
        bodyweight("Swiss Ball Back Extension",        "Exercise Ball Back Extension", "10-20".x(3), restMins: 1.0),
        bodyweight("Side Plank from Knees",            "Side Plank",                   2, secs: 20, targetSecs: 60),
        bodyweight("Situp",                            "Situp",                        "20-30", restMins: 1.0),
        bodyweight("Oblique Crunches",                 "Oblique Crunches",             "20-30", restMins: 1.0),
        
        // C
        bodyweight("Glute March",            "Glute March",               3, secs: 30, targetSecs: 60, main: true),
        bodyweight("Inverted Row",           "Inverted Row",              "8-12".x(3), restMins: 1.0, main: true),
        bodyweight("Box Squat",              "Body-weight Box Squat",     "10-20".x(3), restMins: 1.5, main: true),
        bodyweight("Negative Pushup",        "Pushup",                    "3-5".x(3), restMins: 1.0, main: true),
        bodyweight("Hip Hinge with Dowel",   "Hip Hinge with Dowel",      "10-20".x(3), restMins: 1.0),
    ...
    let tags: [Program.Tags] = [.beginner, .hypertrophy, .minimal, .threeDays, .female] + anyAge
    let description = """
...
func BestButt58() -> Program {
    let exercises: [Exercise] = [
        // A
        bodyweight("Hip Thrust",           "Body-weight Hip Thrust",          "10-30".x(3), restMins: 1.0, main: true),
        bodyweight("Inverted Row",         "Inverted Row",                    "8-12".x(3), restMins: 1.0, main: true),
        bodyweight("Squat",                "Body-weight Squat",               "10-30".x(3), restMins: 1.5, main: true),
        bodyweight("Pushup",               "Pushup",                          "1".x(3), restMins: 1.0, main: true),
        bodyweight("Single Leg Deadlift",  "Body-weight Single Leg Deadlift", "10-20".x(3), restMins: 1.0, main: true),
        bodyweight("Side Lying Abduction", "Side Lying Abduction",            "10-30", restMins: 1.0),
        bodyweight("RKC Plank",            "RKC Plank",                       1, secs: 20, targetSecs: 60),
        bodyweight("Side Plank",           "Side Plank",                      2, secs: 20, targetSecs: 60),
        
        // B
        bodyweight("Single-leg Glute Bridge", "Single Leg Glute Bridge",   "10-20".x(3), restMins: 1.0, main: true),
        bodyweight("Chinup",                  "Chinup",                    "1".x(3), restMins: 1.5, main: true),
        bodyweight("Walking Lunge",           "Body-weight Walking Lunge", "10-20".x(3), restMins: 1.0, main: true),
        bodyweight("Pushup from Knees",       "Pushup",                    "6-20".x(3), restMins: 1.5, main: true),
        bodyweight("Reverse Hyperextension",  "Reverse Hyperextension",    "10-30".x(3), restMins: 1.0),
        ...
        bodyweight("Hip Thrust",             "Body-weight Hip Thrust",    "10-30".x(3), restMins: 1.0, main: true),
        bodyweight("Inverted Row",           "Inverted Row",              "8-12".x(3), restMins: 1.0, main: true),
        bodyweight("High Step-ups",          "Deep Step-ups",             "10-20".x(3), restMins: 1.0, main: true),
        bodyweight("Incline Pushup",         "Incline Pushup",            "8-12".x(3), restMins: 1.5, main: true),
        bodyweight("Back Extension",         "Back Extension",            "20-30".x(3), restMins: 1.0),
...
func BestButt912() -> Program {
    let exercises: [Exercise] = [
        // A
        bodyweight("Elevated Single-leg Hip Thrust", "Body-weight Single Leg Hip Thrust",   "8-20".x(3), restMins: 1.0, main: true),
        bodyweight("Chinup",                         "Chinup",                              "3-10".x(3), restMins: 1.5, main: true),
        bodyweight("Step Up + Reverse Lunge",        "Body-weight Step Up + Reverse Lunge", "3-15".x(3), restMins: 1.5, main: true),
        bodyweight("Pushup",                         "Pushup",                              "5-10".x(3), restMins: 1.5, main: true),
        bodyweight("Swiss Ball Back Extension",      "Exercise Ball Back Extension",        "8-20".x(3), restMins: 1.0),
        ...
        // B
        bodyweight("Elevated Hip Thrust",       "Body-weight Hip Thrust",            "6-20".x(3), restMins: 1.0, main: true),
        bodyweight("Elevated Inverted Row",     "Inverted Row",                      "6-12".x(3), restMins: 1.0, main: true),
        bodyweight("Bulgarian Split Squat",     "Body-weight Bulgarian Split Squat", "5-30".x(3), restMins: 1.0, main: true),
        bodyweight("Elevated Pike Pushup",      "Pike Pushup",                       "6-20".x(3), restMins: 1.0, main: true),
        bodyweight("Sliding Leg Curl",          "Sliding Leg Curl",                  "10-20".x(2), restMins: 1.0),
        ...
        // C
        bodyweight("Elevated Single-leg Hip Thrust",     "Body-weight Hip Thrust", "5-15".x(3), restMins: 1.5, main: true),
        bodyweight("Pullup",                             "Pullup",                 "3-10".x(3), restMins: 1.5, main: true),
        bodyweight("High Step-ups",                      "Deep Step-ups",          "3-15".x(3), restMins: 1.0, main: true),
        bodyweight("Narrow-base Pushup",                 "Pushup",                 "3-8".x(3), restMins: 1.5, main: true),
        bodyweight("Russian Leg Curls",                  "Russian Leg Curl",       "3-5".x(3), restMins: 1.0),
        bodyweight("Side Lying Hip Raise",               "Side Lying Hip Raise",   "10-20", restMins: 1.0),
