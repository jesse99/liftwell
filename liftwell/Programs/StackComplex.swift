...
func StackComplex() -> Program {
    ...
    let tags: [Program.Tags] = [.beginner, .conditioning, .dumbbell, .threeDays] + anyAge + anySex
...
func PerryComplex() -> Program {
    ...
    let tags: [Program.Tags] = [.beginner, .conditioning, .dumbbell] + anyAge + anyDays + anySex
