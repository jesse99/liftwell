...
func MastersDB() -> Program {
    let exercises = [
        ...
        // Medium
        dumbbell2("Medium Bench",    "Dumbbell Bench Press",            "10@50% 3@70% 1@90%", "4-10".x(3, rest: .atEnd), percent: 0.94, other: "Heavy Bench", restMins: 4.0),
        dumbbell2("Medium Squat",    "Dumbbell Single Leg Split Squat", "5@50% 3@75%",        "4-8".x(3, rest: .atEnd), percent: 0.94, other: "Heavy Squat", restMins: 4.0),
