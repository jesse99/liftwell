...
func GZCL() -> Program {
    ...
    let exercises: [Exercise] = [
        ...
        barbellT1("T2 Paused Squat",    "Low bar Squat",       t2, restMins: 2.5),
        barbellT1("T2 Paused Bench",    "Bench Press",         t2, restMins: 2.5),
        barbellT1("T2 Paused Deadlift", "Deadlift",            t2, restMins: 2.5, bumpers: defaultBumpers()),
