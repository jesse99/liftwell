...
func GlutealGoddess1() -> Program {
    let exercises: [Exercise] = [
        // A
        barbell("Glute Bridge",            "Glute Bridge",           "", "20 R 20 R 20", restMins: 2.0),
        dumbbell1("One Arm Row",            "Kroc Row",               "", "8 R 8 R 8", restMins: 1.0),
        barbell("Box Squat",               "Body-weight Box Squat",  "", "5 R 5 R 5", restMins: 2.0),
        dumbbell2("Dumbbell Incline Press", "Dumbbell Incline Press", "", "8 R 8 R 8", restMins: 1.0),
        barbell("Deadlift",                "Deadlift",               "", "8 R 8 R 8", restMins: 2.0),
        ...
        // B
        bodyweight("Single Leg Hip Thrust",   "Body-weight Single Leg Hip Thrust", "8-20 R 8-20 R 8-20", restMins: 1.0),
        bodyweight("Chinup",                  "Chinup",                            "5 R 5 R 5", restMins: 2.0),
        dumbbell2("Dumbbell Step Up",          "Deep Step-ups",                     "", "10 R 10 R 10", restMins: 2.0),
        barbell("Overhead Press",             "Overhead Press",                    "", "8 R 8 R 8", restMins: 2.0),
        ...
        // C
        barbell("Hip Thrust",              "Hip Thrust",                   "", "20 R 20 R 20", restMins: 2.0),
        cable("One Arm Cable Row",       "Standing One Arm Cable Row",   "", "8 R 8 R 8", restMins: 1.0),
        dumbbell1("Goblet Squat",           "Goblet Squat",                 "", "5 R 5 R 5", restMins: 2.0),
        dumbbell1("One Arm Bench Press",    "Dumbbell One Arm Bench Press", "", "8 R 8 R 8", restMins: 1.0),
...
func GlutealGoddess2() -> Program {
    let exercises: [Exercise] = [
        // A
        barbell("Hip Thrust",                 "Hip Thrust",              "", "3-8 R 3-8 R 3-8", restMins: 2.0),
        cable("Seated Row",                 "Seated Cable Row",        "", "8 R 8 R 8", restMins: 1.0),
        barbell("Squat",                      "Low bar Squat",           "", "5 R 5 R 5", restMins: 2.0),
        barbell("Bench Press",                "Bench Press",             "", "3-8 R 3-8 R 3-8", restMins: 2.0),
        ...
        // B
        bodyweight("Single Leg Hip Thrust",   "Body-weight Single Leg Hip Thrust", "8-20 R 8-20 R 8-20", restMins: 1.0),
        bodyweight("Pullup",                  "Pullup",                            "3-8 R 3-8 R 3-8", restMins: 2.0),
        dumbbell2("Dumbbell Lunge",            "Dumbbell Lunge",                    "", "10 R 10 R 10", restMins: 2.0),
        barbell("Push Press",                 "Push Press",                        "", "6 R 6 R 6", restMins: 2.0),
        ...
        // C
        barbell("Hip Thrust (isohold)",         "Hip Thrust (isohold)",         "", "1 R 1 R 1", restMins: 2.0),
        cable("D-handle Lat Pulldown",        "Lat Pulldown",                 "", "8 R 8 R 8", restMins: 1.0),
        bodyweight("Skater Squat",              "Skater Squat",                 "8 R 8 R 8", restMins: 1.0),
        bodyweight("Narrow-base Pushup",        "Pushup",                       "5-15 R 5-15 R 5-15", restMins: 2.0),
        barbell("Single-leg Romanian Deadlift", "Single Leg Romanian Deadlift", "", "8-12 R 8-12 R 8-12", restMins: 2.0),
...
func GlutealGoddess3() -> Program {
    let exercises: [Exercise] = [
        // A
        barbell("Hip Thrust (rest pause)", "Hip Thrust (rest pause)", "", "10 R 10 R 10", restMins: 2.0),
        bodyweight("Inverted Row",         "Inverted Row",            "6-12 R 6-12 R 6-12", restMins: 1.0),
        barbell("Zercher Squat",           "Zercher Squat",           "", "5-10 R 5-10 R 5-10", restMins: 2.0),
        bodyweight("Elevated Pushup",      "Pushup",                  "5-20 R 5-20 R 5-20", restMins: 1.0),
        ...
        // B
        barbell("Hip Thrust (constant tension)",  "Hip Thrust (constant tension)",   "", "20-30 R 20-30 R 20-30", restMins: 2.0),
        bodyweight("Pullup",                      "Pullup",                          "1-3 R 1-3 R 1-3", restMins: 2.0),
        dumbbell2("Deficit Bulgarian Split Squat", "Dumbbell Single Leg Split Squat", "", "10 R 10 R 10", restMins: 2.0),
        barbell("Incline Press",                  "Incline Bench Press",             "", "6-10 R 6-10 R 6-10", restMins: 2.0),
        ...
        // C
        barbell("Hip Thrust",                 "Hip Thrust",                      "", "5 R 5 R 5", restMins: 2.5),
        dumbbell2("Chest Supported Row",       "Dumbbell Incline Row",            "", "6-12 R 6-12 R 6-12", restMins: 2.0),
        dumbbell2("Dumbbell Step Up",          "Deep Step-ups",                   "", "8-15 R 8-15 R 8-15", restMins: 2.0),
        dumbbell1("One Arm OHP",               "Dumbbell One Arm Shoulder Press", "", "8-15 R 8-15 R 8-15", restMins: 2.0),
